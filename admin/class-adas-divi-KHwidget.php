...
class Adas_Divi_KHwidget
{
    ...
    public function register_divi_table_dashboard_widget()
    {
    ...
    public function my_divi_table_dashboard_widget_display()
    {
        global $wpdb;
...
//Display last entry
    ...
    //Show last entry
    public function my_first_custom_widget_display()
    {
